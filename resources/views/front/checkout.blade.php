                                ...
                                <div class="checkout-right">
                                    ...
                                    <div class="aa-order-summary-area">
                                        <table class="table table-responsive">
                                            ...
                                            <tfoot>
                                                <tr class="hide show_coupan_box">
                                                    <th>Coupan Code<a href="javascript:void(0)" onclick="remove_coupan_code()" class="remove_coupan_code_link">Remove</a></th>
                                                    <td id="coupan_code_str"></td>
                                                </tr>
                                    ...
                                    <h4>coupan Code</h4>
                                    <div class="aa-payment-method coupan_code">
                                        <input type="text" placeholder="coupan Code" class="aa-coupan-code apply_coupan_code_box" name="coupan_code" id="coupan_code">
                                        <input type="button" value="Apply coupan" class="aa-browse-btn apply_coupan_code_box" onclick="applycoupanCode()">
                                        <div id="coupan_code_msg"></div>
                                    </div>
                                    <br />
