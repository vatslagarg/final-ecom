                    ...
                    <div class="table-responsive">
                        <table class="table order_detail">
                            ...
                            <tbody>
                                ...
                                <?php
                      if($orders_details[0]->coupan_value>0){
                        echo '<tr>
                          <td colspan="5">&nbsp;</td>
                          <td><b>coupan <span class="coupan_apply_txt">('.$orders_details[0]->coupan_code.')</span></b></td>
                          <td>'.$orders_details[0]->coupan_value.'</td>
                        </tr>';
                        $totalAmt=$totalAmt-$orders_details[0]->coupan_value;
                        echo '<tr>
                          <td colspan="5">&nbsp;</td>
